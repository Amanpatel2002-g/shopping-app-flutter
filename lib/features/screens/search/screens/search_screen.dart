...
import 'package:amazon_new/features/screens/search/services/search_service.dart';
import 'package:amazon_new/features/screens/search/widgets/search_product.dart';
...
class _SearchScreenState extends State<SearchScreen> {
  ...
  final SearchServcies homeServcies = SearchServcies();
  @override
  void initState() {
    super.initState();
    fetchSearchProduct();
  ...
  fetchSearchProduct() async {
    productList = await homeServcies.fetchSearchedProducts(
